...
- **Never:** Set `app.visibility: 'disabled'` on an SDK app — it makes the app unreachable (hidden from the sidebar _and_ 404 on the direct link). Use `'unlisted'` to hide it while keeping the link openable.
